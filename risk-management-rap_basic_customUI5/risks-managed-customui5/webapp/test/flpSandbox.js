		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom UI5",
									"targetURL": "#rapcustomrisksmanagedcustomui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rapcustomrisksmanagedcustomui5-display": {
								"semanticObject": "rapcustomrisksmanagedcustomui5",
								"action": "display",
								"description": "RAP Custom App",
								"title": "Custom UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rap.custom.risksmanagedcustomui5",
									"url": sap.ui.require.toUrl("rap/custom/risksmanagedcustomui5")
								}
							}
						}
					}
